...
//보안을 위해 제공해드리는 샘플페이지는 서비스 적용 후 서버에서 삭제해 주시기 바랍니다. 
	...
	*********************************************************************************************************************************************/
	...
	$sModulePath			= "/home/datafirst/www/htdocs/test/ipin/IPIN2Client";			// 하단내용 참조
	$sReturnURL				= "https://www.datafirst.co.kr/test/ipin/ipin_process.php";			// 하단내용 참조
	$sCPRequest				= "";			// 하단내용 참조  30byte안으로 ( md5로 암호화)
	
	echo `pwd`;
	
	// 실행방법은 싱글쿼터(`) 외에도, 'exec(), system(), shell_exec()' 등등 귀사 정책에 맞게 처리하시기 바랍니다.  //안뜸!
	$sCPRequest = `$sModulePath SEQ $sSiteCode`;
	
	echo `$sModulePath SEQ $sSiteCode`;
