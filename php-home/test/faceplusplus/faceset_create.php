...
$(document).ready(function() {
  ...
  $.post("https://api-us.faceplusplus.com/facepp/v3/faceset/create", $("#db-form").serialize(), function(response) {
...
<input type="text" name="outer_id" value="avdbs_faceset">
<input type="text" name="tags" value="actor">
</form>
