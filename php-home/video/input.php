<?
	...
	list($id, $title, $appoint_wait_cnt, $test_wait_cnt, $waiting_time) = fetch_first_row($mysqli, "SELECT id, title, appoint_wait_cnt, test_wait_cnt, waiting_time FROM waiting ORDER BY id DESC LIMIT 0, 1");
